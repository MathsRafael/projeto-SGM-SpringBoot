    ...
    SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(HttpMethod.GET,"/api/instituicoes/**").authenticated()
                        ...
                        .requestMatchers("/api/processos-seletivos/**").hasRole(COORDENADOR)
                        .requestMatchers(HttpMethod.GET, "/api/monitorias/**").authenticated()
                        .requestMatchers(HttpMethod.POST, "/api/monitorias/{id}/inscrever-se").hasRole(DISCENTE)
                        .requestMatchers("/api/monitorias/**").hasAnyRole(ADMIN, COORDENADOR)
                        ...
                        .requestMatchers(HttpMethod.GET, "/api/alunos/minhas-inscricoes").hasRole(DISCENTE)
